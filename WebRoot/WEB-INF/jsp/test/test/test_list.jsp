	...
	<div class="container-fluid" id="main-container">
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="test/list.do" method="post" name="Form"
						id="Form">
						<table>
							<tr>
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													<td class='center' style="width: 30px;"><label><input
															type='checkbox' name='ids' value="${var.TEST_ID}" /><span
															class="lbl"></span></label></td>
													<td class='center' style="width: 30px;">${vs.index+1}</td>
													<td>${var.CODE}</td> 													<td>${var.NAME}</td> 													<td>${var.INFO}</td> 
																...
																<ul
																	...
																	<c:if test="${QX.edit == 1 }">
																		<li><a style="cursor: pointer;" title="编辑"
																			onclick="edit('${var.TEST_ID}');" class="tooltip-success"
																	...
																	<c:if test="${QX.del == 1 }">
																		<li><a style="cursor: pointer;" title="删除"
																			onclick="del('${var.TEST_ID}');" class="tooltip-error"
																			data-rel="tooltip" title="" data-placement="left"><span
